              ...
              <div class="row mt-3">
                <div class="col-md-12 text-center text-md-left text-md-right">
                  <button
                    ...
                    v-on:click="addProductToCart({ product: product, quantity: quantity })"
                  >
                    <i class="fas fa-cart-plus mr-2" aria-hidden="true"></i> Lägg till varukorgen
                  </button>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...mapActions(["getProductById", "addProductToCart", "initProduct"]),
  },
  computed: {
